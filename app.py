...
st.markdown("""
    <style>
    /* 1. ซ่อนเมนูและลายน้ำของ Streamlit เพื่อความพรีเมียม */
    #MainMenu {visibility: hidden;}
    footer {visibility: hidden;}
    header {visibility: hidden;}
    
    /* 2. ตกแต่งพื้นหลังแอปพลิเคชัน (สีเทาอ่อนๆ ให้ดูสะอาดตา) */
    .stApp {
        background-color: #f8f9fa;
    }
    
    /* 3. ตกแต่งปุ่มกดหลัก (ปุ่ม Generate) */
    .stButton>button {
...
# --- ดึง API Key จากระบบ Secrets ของเซิร์ฟเวอร์ ---
...
st.write("") # เว้นบรรทัดเพื่อความสวยงาม
